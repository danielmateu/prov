...
export default function ContactadosPage() {
    ...
    const contactedNotices = notices.filter(
        notice => notice.StatusID === 26 || notice.StatusID === 27 || notice.StatusID === 57 || notice.StatusID === 36 || notice.StatusID === 35
    );
                ...
                <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        ...
                        <Badge variant="secondary" className="text-sm">
                            {contactedNotices.length} avisos contactados
                        </Badge>
                    </div>
                </div>
            </header>
