...
const Footer = () => {
    ...
    return (
        <footer className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 mx-auto px-4 sm:px-6 lg:px-8 pb-5 w-full" >
            <div className="pt-8">
                ...
                <div className="flex md:justify-between md:items-end md:flex-row flex-col gap-8 md:gap-0">
                    ...
                    <div className=''>
                        ...
                        <ul className="space-y-2 text-gray-600 dark:text-gray-400 text-sm">
                            ...
                            {/* <li>Email: itsupport@rapitecnic.com</li> */}
                            ...
                            <li>
                                <div className="flex gap-2 items-center">
                                    <Mail size={16} />
                                    <a
                                        href="mailto:itsupport@rapitecnic.com?subject=Soporte técnico&body=Hola equipo de soporte,%0D%0A%0D%0ANecesito ayuda con..."
                    ...
                    <div className='pr-14'>
                        ...
                        <div className="flex space-x-4">
                            ...
                            <a href="https://www.tiktok.com/@rapitecnicsl" className="text-gray-500 hover:text-blue-500 dark:text-gray-400 dark:hover:text-blue-400 transition-colors duration-300" target="_blank" rel="noopener noreferrer">
            ...
            <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700 flex flex-col md:flex-row justify-between items-center">
                <p className="text-gray-500 dark:text-gray-400 text-sm">
                    © {currentYear} Rapitecnic. {t("AllRightsReserved")}.
                </p>
                <div className="mt-4 md:mt-0 flex items-center">
                    <span className="text-gray-500 dark:text-gray-400 text-sm flex items-center pr-14">
                        {t("MadeWith")} <Heart className="h-4 w-4 mx-1 text-red-500 animate-pulse" /> {t("By")}
                    </span>
                </div>
            </div>
        </footer>
