        ...
        <div className="space-y-6" ref={formRef}>
            <div className="border-t pt-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4 dark:text-slate-200">
                    Detalles de la Reclamación para aviso {selectedNotice.DocEntry}
                </h3>
                ...
                <div>
                    ...
                    <Textarea
                        ...
                        placeholder="Describa detalladamente la reclamación que desea realizar..."
                        rows={6}
                        required
                ...
                <div className="flex justify-end space-x-4 mt-8 pt-6 border-t">
                    <button
                        type="button"
                        onClick={onCancel}
                        className="px-6 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors dark:text-slate-200 hover:dark:bg-gray-900"
                    >
                        Cancelar
                    </button>
                    <button
